...
public class DLeftHashTableFlowId2{
	...
	public DLeftHashTableFlowId2(int tableSize, SummaryStructureType type, int numberOfFlows, int D, HashMap<String,Integer> flowSizes){
