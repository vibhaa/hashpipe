...
public class TopKIdentifier2{
	...
	public static void runTopKIdentificationTrials(SummaryStructureType type, ArrayList<Packet> inputStream, int[] k, int tableSize, int D, double[] thetaValues){
		...
		for (int k_index = 0; k_index < k.length; k_index++){
			...
			System.out.println("," + theoreticalProb[k_index] + "," + (double) numWithin1Dev[k_index]/numberOfTrials + "," + (double) numWithin2Dev[k_index]/numberOfTrials);
		}
	...
	public static void main(String[] args){
		...
		if (args[2].equals("runTrial"))	{
			...
			System.out.print("reported number, hhReportedFraction, deviation, table occupancy, duplicates, fraction missing in table,");
			System.out.println(" theoretical Prob, P(within 1 stddev), P(within 2 stddev)");
